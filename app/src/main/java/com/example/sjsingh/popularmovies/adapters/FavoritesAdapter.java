...
public class FavoritesAdapter extends RecyclerView.Adapter<FavoritesAdapter.ViewHolder> {
    ...
    public FavoritesAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final FavoritesAdapter.ViewHolder vh = new FavoritesAdapter.ViewHolder(view);
        return vh;
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            intent.putExtra(mContext.getString(R.string.title_key), mCursor.getString(mCursor.getColumnIndex(DatabaseContract.PopularMovieData.COLUMN_MOVIE_TITLE)));
            ...
            intent.putExtra(mContext.getString(R.string.poster_key), mCursor.getString(mCursor.getColumnIndex(DatabaseContract.PopularMovieData.COLUMN_POSTER)));
